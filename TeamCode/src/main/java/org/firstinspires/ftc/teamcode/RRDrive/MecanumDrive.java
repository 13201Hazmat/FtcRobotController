...
public class MecanumDrive {
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "leftFront_par0"); //3
        leftBack = hardwareMap.get(DcMotorEx.class, "leftBack_par1");//0
        rightBack = hardwareMap.get(DcMotorEx.class, "rightBack"); //1
        rightFront = hardwareMap.get(DcMotorEx.class, "rightFront_perp"); //2
