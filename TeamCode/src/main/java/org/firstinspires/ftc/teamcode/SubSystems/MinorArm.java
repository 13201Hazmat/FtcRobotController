...
public class MinorArm {
    ...
    public static final double PICKUP_POSITION_COUNT = 0.0;
    public static final double LEVEL1_POSITION_COUNT = 0.33;
    public static final double PARKED_POSITION_COUNT = 1.0;
